  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 bg-[#f9f8f4]">
      <div className="bg-white p-10 rounded-sm shadow-sm max-w-md w-full border border-[#e5e1d5]">
        ...
        <h2 className="text-3xl font-serif font-light text-center text-[#333] mb-2 uppercase tracking-widest">Create Profile</h2>
        <p className="text-center text-[#666] mb-10 font-light text-sm italic">Join our community to start your journey.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-[10px] uppercase tracking-[0.2em] font-bold text-[#666] mb-2">Full Name</label>
            <input 
              type="text" 
        ...
        <p className="mt-10 text-center text-[11px] text-[#888] font-light">
          Already have an account? <Link to="/login" className="text-[#333] hover:text-[#c2a46b] font-medium underline underline-offset-4 decoration-[#e5e1d5] transition-all">Log In</Link>
        </p>
      </div>
    </div>
  );
